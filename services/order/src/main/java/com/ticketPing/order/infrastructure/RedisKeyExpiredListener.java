...
//    }
//
//    private SeatResponse getRedisSeat(String redisKey) {
...
//
//        try {
//            return objectMapper.readValue(value, SeatResponse.class);
...
//    }
//
//    private String getRedisWriteSeat(SeatResponse redisSeat) {
//        if (redisSeat == null) {
//            throw new ApplicationException(ORDER_FOR_PERFORMANCE_CACHE_NOT_FOUND);
//        }
//
